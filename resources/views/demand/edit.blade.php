            ...
            <div class="card">
                ...
                <form method="POST" action="{{route('demand.update', $offre->id)}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea cols="30" rows="10" id="description" type="description" value="{{$offre->description}}"  class="form-control @error('description') is-invalid @enderror" name="description"  autocomplete="current-description">{{$offre->description}}</textarea>
